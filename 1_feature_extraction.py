...
for i in range(0, len(file_list)):
    ...
    # 8. Parametry elipsy otaczającej otoczkę wypukłą. 8a, 8b, 8c, 8d, 8e - środek, osie oraz kąt nachylenia elipsy.
...
df.to_csv("data/ear_data_aug.csv", index=False)
